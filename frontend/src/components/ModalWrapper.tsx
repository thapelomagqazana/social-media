    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          <motion.div
            className="fixed top-1/2 left-1/2 z-50 w-[90%] max-w-md max-h-[90vh] overflow-y-auto scrollbar-thin scrollbar-thumb-indigo-500 scrollbar-track-zinc-800 bg-white dark:bg-zinc-900 rounded-xl p-6 shadow-xl"
